...
class ProcesadorArchivo extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            BufferedReader buff = new BufferedReader(new InputStreamReader(urlArchivo.openStream()));
            int lineas = 0;
...
public class AnalizadorArchivo {
    ...
    public static void main(String[] args) {
        ...
        for (String archivo : archivos) {
            ...
            ProcesadorArchivo procesadoArchivo = new ProcesadorArchivo(url, resultados);
            procesadoArchivo.start();
            try {
                procesadoArchivo.join();
